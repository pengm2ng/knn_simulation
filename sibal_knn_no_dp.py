...
def simulate_sibal_knn(agent_num, map_type, explored_data, k, monte_num,init_position):
            ...
            for ag in range(agent_num):
                ...
                if len(new_candidate_node) != 0:
                    ...
                    for w in range(len(path_length_list)):
                            ...
                            k_next_frontier_node_temp.append([new_candidate_node[w], ag, 0, path_length_list[w], path_list[w]])
            ...
            for i, ag in enumerate(null_agent):
                ...
                if len(non_selected_agent_path_length) == 0:
                    ...
                    for w in range(len(non_selected_agent_path_length)):
                            ...
                            k_next_frontier_node_temp.append([non_selected_agent_node[w], null_agent[i],0, non_selected_agent_path_length[w], non_selected_agent_path[w]])
    ...
    f = open("C:/Users/장인호/Desktop/knn_simulation/result/nodp.txt", 'a')
